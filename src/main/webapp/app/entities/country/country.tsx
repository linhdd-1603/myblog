    ...
    return (
      <div>
        <h2 id="country-heading">
          <Translate contentKey="myblogApp.country.home.title">Countries</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="myblogApp.country.home.createLabel">Create new Country</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('myblogApp.country.home.search')}
                  />
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="myblogApp.country.countryName">Country Name</Translate>
                </th>
                <th />
              </tr>
            </thead>
