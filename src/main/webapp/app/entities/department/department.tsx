    ...
    return (
      <div>
        <h2 id="department-heading">
          <Translate contentKey="myblogApp.department.home.title">Departments</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="myblogApp.department.home.createLabel">Create new Department</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('myblogApp.department.home.search')}
                  />
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="myblogApp.department.departmentName">Department Name</Translate>
                </th>
                <th />
              </tr>
            </thead>
