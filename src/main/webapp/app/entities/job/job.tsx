...
export class Job extends React.Component<IJobProps, IJobState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="job-heading">
          <Translate contentKey="myblogApp.job.home.title">Jobs</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="myblogApp.job.home.createLabel">Create new Job</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('myblogApp.job.home.search')}
                  />
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="myblogApp.job.jobTitle">Job Title</Translate>
                </th>
                <th>
                  <Translate contentKey="myblogApp.job.minSalary">Min Salary</Translate>
                </th>
                <th>
                  <Translate contentKey="myblogApp.job.maxSalary">Max Salary</Translate>
                </th>
                <th />
              </tr>
            </thead>
