...
import { getSearchEntities, getEntities } from './job-history.reducer';
    ...
    return (
      <div>
        <h2 id="job-history-heading">
          <Translate contentKey="myblogApp.jobHistory.home.title">Job Histories</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="myblogApp.jobHistory.home.createLabel">Create new Job History</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('myblogApp.jobHistory.home.search')}
                  />
            ...
            <tbody>
              {jobHistoryList.map((jobHistory, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <Translate contentKey={`myblogApp.Language.${jobHistory.language}`} />
                  </td>
