    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="myblogApp.post.home.createOrEditLabel">
              <Translate contentKey="myblogApp.post.home.createOrEditLabel">Create or edit a Post</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : postEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="regionNameLabel" for="post-regionName">
                    <Translate contentKey="myblogApp.post.regionName">Region Name</Translate>
                  </Label>
                  <AvField id="post-regionName" type="text" name="regionName" />
                </AvGroup>
