...
export class Post extends React.Component<IPostProps, IPostState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="post-heading">
          <Translate contentKey="myblogApp.post.home.title">Posts</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="myblogApp.post.home.createLabel">Create new Post</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('myblogApp.post.home.search')}
                  />
