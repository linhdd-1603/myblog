    ...
    return (
      <div>
        <h2 id="location-heading">
          <Translate contentKey="myblogApp.location.home.title">Locations</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="myblogApp.location.home.createLabel">Create new Location</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('myblogApp.location.home.search')}
                  />
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="myblogApp.location.streetAddress">Street Address</Translate>
                </th>
                <th>
                  <Translate contentKey="myblogApp.location.postalCode">Postal Code</Translate>
                </th>
                <th>
                  <Translate contentKey="myblogApp.location.city">City</Translate>
                </th>
                <th>
                  <Translate contentKey="myblogApp.location.stateProvince">State Province</Translate>
                </th>
                <th />
              </tr>
            </thead>
